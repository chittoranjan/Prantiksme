...
namespace PrantiksmeApp.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> RemoveLogin(string loginProvider, string providerKey)
        {
            ...
            var result = await UserManager.RemoveLoginAsync(User.Identity.GetUserId<long>(),
        ...
        public async Task<ActionResult> AddPhoneNumber(AddPhoneNumberViewModel model)
        {
            ...
            var code = await UserManager.GenerateChangePhoneNumberTokenAsync(
                User.Identity.GetUserId<long>(), model.Number);
        ...
        {
            var code = await UserManager.GenerateChangePhoneNumberTokenAsync(
                User.Identity.GetUserId<long>(), phoneNumber);
        ...
        public async Task<ActionResult> VerifyPhoneNumber(VerifyPhoneNumberViewModel model)
        {
            ...
            var result = await UserManager.ChangePhoneNumberAsync(
                User.Identity.GetUserId<long>(), model.PhoneNumber, model.Code);
            if (result.Succeeded)
            {
                var user = await UserManager.FindByIdAsync(User.Identity.GetUserId<long>());
                if (user != null)
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            var result = await UserManager.ChangePasswordAsync(
                User.Identity.GetUserId<long>(), model.OldPassword, model.NewPassword);
            if (result.Succeeded)
            {
                var user = await UserManager.FindByIdAsync(User.Identity.GetUserId<long>());
                if (user != null)
        ...
        public async Task<ActionResult> LinkLoginCallback()
        {
            ...
            var result = await UserManager.AddLoginAsync(User.Identity.GetUserId<long>(),
                loginInfo.Login);
